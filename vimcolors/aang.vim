...
let s:voidGray5 = {'gui': '#E4E4E4', 'cterm256': '259'}
"pure white
let s:voidSteel = {'gui': '#FFFFFF', 'cterm256': '231'}
"let s:voidSteel = {'gui': '#D0D0D0', 'cterm256': '252'}
let s:voidBlue = {'gui': '#699B9B', 'cterm256': '109'}
"cursor
let s:voidGreen = {'gui': '#569F7A', 'cterm256': '72'}
let s:voidCyan = {'gui': '#00D7AF', 'cterm256': '43'}
...
" Editor
call <sid>hi('ColorColumn', s:none, s:voidGray2, 'none')
call <sid>hi('Cursor', s:voidBlack, s:voidCyan, 'none')
...
call <sid>hi('CursorLineNr', s:voidSteel, s:voidGray1, 'bold')
...
call <sid>hi('IncSearch', s:voidSteel, s:voidCyan, 'bold')
call <sid>hi('LineNr', s:voidGray4, s:voidBlack2, 'none')
...
call <sid>hi('Search', s:voidBlack, s:voidCyan, 'none')
...
" General
call <sid>hi('Boolean', s:voidSteel, s:none, 'bold')
call <sid>hi('Character', s:voidGray5, s:none, 'none')
call <sid>hi('Comment', s:voidGray3, s:none, 'none')
call <sid>hi('Conditional', s:voidSteel, s:none, 'bold')
...
call <sid>hi('DiffChange', s:voidBlack, s:voidCyan, 'none')
...
" a function shouldn't be white @@@
call <sid>hi('Float', s:voidSteel, s:none, 'none')
call <sid>hi('Function', s:voidGray5, s:none, 'bold')
...
call <sid>hi('Label', s:voidGray4, s:none, 'none')
call <sid>hi('NonText', s:voidGray3, s:none, 'none')
"put numbers bold @@@
call <sid>hi('Number', s:voidSteel, s:none, 'bold')
call <sid>hi('Operator', s:voidGray4, s:none, 'none')
...
call <sid>hi('Todo', s:voidGray4, s:none, 'bold')
...
if &diff
  ...
  call <sid>hi('DiffChange', s:voidCyan, s:none, 'none')
...
" ------------
" Java
call <sid>hi('javaConstant', s:voidSteel, s:none, 'bold')
call <sid>hi('javaFunction', s:voidSteel, s:none, 'bold')
call <sid>hi('javaFormat', s:voidSteel, s:none, 'none')
call <sid>hi('javaMulti', s:voidSteel, s:none, 'none')
call <sid>hi('javaNumbers', s:voidSteel, s:none, 'bold')
call <sid>hi('javaOperator', s:voidSteel, s:none, 'none')
call <sid>hi('javaSpecial', s:voidSteel, s:none, 'none')
call <sid>hi('javaSpecialCharacter', s:voidSteel, s:none, 'none')
call <sid>hi('javaStatement', s:voidSteel, s:none, 'none')
call <sid>hi('javaStorageClass', s:voidSteel, s:none, 'none')
call <sid>hi('javaString', s:voidGray4, s:none, 'none')
call <sid>hi('javaStructure', s:voidSteel, s:none, 'none')
call <sid>hi('javaType', s:voidSteel, s:none, 'bold')

" C
call <sid>hi('cConstant', s:voidSteel, s:none, 'bold')
...
call <sid>hi('cType', s:voidSteel, s:none, 'bold')

" C++
call <sid>hi('cppConstant', s:voidSteel, s:none, 'bold')
...
call <sid>hi('cppOperator', s:voidSteel, s:none, 'bold')
call <sid>hi('cppSpecial', s:voidSteel, s:none, 'none')
call <sid>hi('cppSpecialCharacter', s:voidSteel, s:none, 'none')
call <sid>hi('cppStatement', s:voidSteel, s:none, 'bold')
call <sid>hi('cppStorageClass', s:voidSteel, s:none, 'bold')
...
call <sid>hi('cppType', s:voidSteel, s:none, 'bold')
...
call <sid>hi('javaScriptStringS', s:voidGray4, s:none, 'none')
